...
for d1_h in d1_h_list:
    ...
    ec1_list_2loipa = []
    ec2_list_2loipa = []
    r_start_2loipa = (-eud-eps2)/(1-d1_h)
    r_end_2loipa = (-eyd-eps2)/(1-d1_h)
    ...
    if d1_h==0.05:
        ...
        critical_pairs_region1.append((2.7,-eyd))
        ...
        critical_pairs_region1.append((ecu2,-eyd))
        critical_pairs_region2.append((ec2,-eyd))
        critical_pairs_region1.append((3.1,-eyd))
